                            ...
                            <div class="modal-body">
                                <form  method="post" action="{{ route('slider.store') }}" enctype="multipart/form-data">
                                  ...
                                  <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            <label for="button_name_en">Slider Btn Name (En):</label>
                                        ...
                                        <div class="form-group">
                                            <label for="button_name_bn">Slider Btn Name (Bn):</label>
                                            @error('button_name_bn')
                                                <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                            <input type="text" name="button_name_bn" class="form-control" id="button_name_bn" placeholder="Write slider button name bangla">
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                          <label for="slider_image" class="col-form-label col-md-4" style="font-weight: bold;">Slider Photo (Size:1349,385):</label>
                                            ...
                                            <div class="card-body">
                                                  <div class="form-group">
                                                      ...
                                                      @error('name_en')
                                                          <span class="text-danger">{{ $message }}</span>
                                                      @enderror
                                                      <input type="text" name="name_en" class="form-control" id="name_en" placeholder="Write name " value="{{ $slider->name_en}}">
                                                  </div>
                                                  ...
                                                  <div class="form-group">
                                                      ...
                                                      @error('title_en')
                                                          <span class="text-danger">{{ $message }}</span>
                                                      @enderror
                                                      <input type="text" name="title_en" class="form-control" id="title_en" placeholder="Write title name" value="{{ $slider->title_en}}">
                                                  </div>
                                                  ...
                                                  <div class="form-group">
                                                      ...
                                                      @error('button_name_en')
                                                          <span class="text-danger">{{ $message }}</span>
                                                      @enderror
                                                      <input type="text" name="button_name_en" class="form-control" id="button_name_en" placeholder="Write slider button name" value="{{ $slider->button_name_en}}">
                                                  </div>
