...
class FrontendController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $skills = Skill::where('status',1)->orderBy('id','ASC')->limit(1)->get();
        $services = Service::where('status',1)->orderBy('id','ASC')->limit(1)->get();

    	return view('frontend.index',compact('menus','tab_menus','projects','teams','testimonials','blogs','chooses','skills','services'));
    } // end method
    /*=================== End Index Methoed ===================*/
