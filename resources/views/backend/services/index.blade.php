                            ...
                            <div class="modal-body">
                                <form action="{{ route('services.store') }}" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            <label for="service_name_en">Sevice Name (En):</label>
                                        ...
                                        <div class="form-group">
                                            <label for="service_name_bn">Service Name (Bn):</label>
                                            @error('service_name_bn')
                                                <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                            <input type="text" name="service_name_bn" class="form-control" id="service_name_bn" placeholder="Write service name bangla">
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            <label for="service_button_bn">Services Button Name(Bn):</label>
                                            @error('service_button_bn')
                                                <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                            <input type="text" name="service_button_bn" class="form-control" id="service_button_bn" placeholder="Write service button name bangla">
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            <label for="service_description_en">Service Description (En):</label>
                                            @error('service_description_en')
                                                <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                            <textarea name="service_description_en" class="form-control" id="service_description_en" rows="3" cols="5"></textarea>
                                        </div>
                                        <div class="form-group">
                                            <label for="service_description_bn">Service Description (Bn):</label>
                                            @error('service_description_bn')
                                                <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                            <textarea name="service_description_bn" class="form-control" id="service_description_bn" rows="3" cols="5"></textarea>
                                        </div>
                                        <div class="form-group">
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        @error('name_bn')
                                                            <span class="text-danger">{{ $message }}</span>
                                                        @enderror
                                                        <input type="text" name="name_bn" class="form-control" id="name_bn" placeholder="Write name bangla" value="name_bn">
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="title_en">Title (En):</label>
                                                        @error('title_en')
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        @error('service_name_bn')
                                                            <span class="text-danger">{{ $message }}</span>
                                                        @enderror
                                                        <input type="text" name="service_name_bn" class="form-control" id="service_name_bn" placeholder="Write service name bangla" value="{{ $service->service_name_bn }}">
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="menu_id">Menu Name:</label>
                                                        @error('menu_id')
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        @error('service_button_bn')
                                                            <span class="text-danger">{{ $message }}</span>
                                                        @enderror
                                                        <input type="text" name="service_button_bn" class="form-control" id="service_button_bn" placeholder="Write service button name bangla" value="{{ $service->service_button_bn }}">
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="description_en">Description (En):</label>
                                                        @error('description_en')
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        @error('service_description_bn')
                                                            <span class="text-danger">{{ $message }}</span>
                                                        @enderror
                                                        <textarea name="service_description_bn" class="form-control" id="service_description_bn" rows="3" cols="5">{{ $service->service_description_bn }}</textarea>
                                                    </div>
                                                    <div class="form-group">
