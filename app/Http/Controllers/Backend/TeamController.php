...
class TeamController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if($request->hasfile('team_image')){
            ...
            Image::make($image)->resize(261,279)->save('upload/team/'.$name_gen);
        ...
        if($request->description_bn == ''){
            $team->description_bn = $request->description_en;
        }else{
            $team->description_bn = $request->description_bn;
        }

        $team->team_name_en = $request->team_name_en;
        if($request->team_name_bn == ''){
            $team->team_name_bn = $request->team_name_en;
        }else{
            $team->team_name_bn = $request->team_name_bn;
        }
        $team->designation_en = $request->designation_en;
        if($request->designation_bn == ''){
            $team->designation_bn = $request->designation_en;
        }else{
            $team->designation_bn = $request->designation_bn;
        }
