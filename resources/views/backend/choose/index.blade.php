                              ...
                              <form action="{{ route('choose.store') }}" method="post" enctype="multipart/form-data">
                                 ...
                                 <div class="card-body">
                                    ...
                                    <div class="form-group">
                                       ...
                                       <span class="text-danger">{{ $message }}</span>
                                       @enderror
                                       <input type="text" name="name_bn" class="form-control" id="title_en" placeholder="Write name english">
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <label for="description_en" class="">choose Description En</label>
                                     ...
                                     <div class="form-group">
                                        <label for="description_bn" class="">choose Description Bn</label>
                                    ...
                                    <div class="form-group">
                                       <label for="choose_name_en">choose Name(En):</label>
                                    ...
                                    <div class="form-group">
                                       <label for="choose_name_bn">choose Name(Bn):</label>
                                       @error('choose_name_bn')
                                       <span class="text-danger">{{ $message }}</span>
                                       @enderror
                                       <input type="text" name="choose_name_bn" class="form-control" id="choose_name_bn" placeholder="Write choose name bangla">
                                    </div>
                                    <div class="form-group">
                                       <label for="choose_description_en" class="">choose Description En</label>
                                       <textarea name="choose_description_en" class="description" cols="30" rows="7" class="form-control" ></textarea>
                                       @error('choose_description_en')
                                       <p class="text-danger">{{ $message }}</p>
                                       @enderror
                                    </div>
                                    <div class="form-group">
                                       <label for="choose_description_bn" class="">choose Description Bn</label>
                                       <textarea name="choose_description_bn" class="description" cols="30" rows="7" ></textarea>
                                       @error('choose_description_bn')
                                       <p class="text-danger">{{ $message }}</p>
                                       @enderror
                                    </div>
                                    <div class="form-group">
                  ...
                  <table id="example1" class="table table-bordered table-hover table-striped">
                     <thead>
                        <tr>
                           ...
                           <th>Title (En)</th>
                           <th>Title (Bn)</th>
                           <th>choose Name (En)</th>
                           <th>choose Name (Bn)</th>
                           <th>Status</th>
                           <th>Action</th>
                        </tr>
                     </thead>
                     <tbody>
                        ...
                        <tr>
                           ...
                           <td>{{ $service->choose_name_bn ?? 'NULL' }}</td>
                           <td>
                              @if($service->status == 1)
                              ...
                              <div class="modal fade" id="chooseEdit{{ $service->id }}" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                 ...
                                 <div class="card-body">
                                    ...
                                    <div class="form-group">
                                       ...
                                       <span class="text-danger">{{ $message }}</span>
                                       @enderror
                                       <input type="text" name="name_bn" class="form-control" id="title_en" value="{{ $service->name_bn}}">
                                    </div>
                                    <div class="form-group">
                                       <label for="title_en">Title En:</label>
                                       @error('title_en')
                                    ...
                                    <div class="form-group">
                                     ...
                                     <div class="form-group">
                                        <label for="description_bn" class="">choose Description Bn</label>
                                        <textarea name="description_bn" class="description" cols="30" rows="7" >{{ $service->description_bn }}</textarea>
                                        @error('description_bn')
                                        <p class="text-danger">{{ $message }}</p>
                                        @enderror
                                     </div>
                                    ...
                                    <div class="form-group">
                                       ...
                                       <span class="text-danger">{{ $message }}</span>
                                       @enderror
                                       <input type="text" name="choose_name_bn" class="form-control" id="choose_name_bn" value="{{ $service->choose_name_bn }}">
                                    </div>
                                    <div class="form-group">
                                       <label for="choose_description_en" class="">choose Description En</label>
                                    ...
                                    <div class="form-group">
                                       <label for="choose_description_bn" class="">choose Description Bn</label>
                                       <textarea name="choose_description_bn" class="description" cols="30" rows="7" >{{ $service->choose_description_bn }}</textarea>
                                       @error('choose_description_bn')
                                       <p class="text-danger">{{ $message }}</p>
                                       @enderror
                                    </div>
