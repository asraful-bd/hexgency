...
class ServicesController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if($request->name_bn == ''){
            $service->name_bn = $request->name_en;
        }else{
            $service->name_bn = $request->name_bn;
        }

        $service->service_name_en = $request->service_name_en;
        if($request->service_name_bn == ''){
            $service->service_name_bn = $request->service_name_en;
        }else{
        ...
        if($request->service_description_bn == ''){
            $service->service_description_bn = $request->service_description_en;
        }else{
            $service->service_description_bn = $request->service_description_bn;
        }

        $service->service_button_en = $request->service_button_en;
        if($request->service_button_bn == ''){
            $service->service_button_bn = $request->service_button_en;
        }else{
            $service->service_button_bn = $request->service_button_bn;
        }
