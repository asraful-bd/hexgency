...
class BlogController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if($request->name_bn == ''){
            $blog->name_bn = $request->name_en;
        }else{
            $blog->name_bn = $request->name_bn;
        }
        ...
        if($request->blog_name_bn == ''){
            $blog->blog_name_bn = $request->blog_name_en;
        }else{
            $blog->blog_name_bn = $request->blog_name_bn;
        }
        ...
        if($request->button_name_bn == ''){
            $blog->button_name_bn = $request->button_name_en;
        }else{
            $blog->button_name_bn = $request->button_name_bn;
        }
