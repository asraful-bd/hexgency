                           ...
                           <div class="modal-body">
                              <form action="{{ route('blog.store') }}" method="post" enctype="multipart/form-data">
                                 ...
                                 <div class="card-body">
                                    ...
                                    <div class="form-group">
                                       <label for="blog_name_en">Blog Name(En):</label>
                                       @error('blog_name_en')
                                       <span class="text-danger">{{ $message }}</span>
                                       @enderror
                                    ...
                                    <div class="form-group">
                                       <label for="blog_name_bn">Blog Name(Bn):</label>
                                       @error('blog_name_bn')
                                       <span class="text-danger">{{ $message }}</span>
                                       @enderror
                                       <input type="text" name="blog_name_bn" class="form-control" id="blog_name_bn" placeholder="Write blog name bangla">
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                       <label for="blog_description_en" class="">Blog Description En</label>
                                    ...
                                    <div class="form-group">
                                       <label for="blog_description_bn" class="">Blog Description Bn</label>
                                       <textarea name="blog_description_bn" class="description" cols="30" rows="7" ></textarea>
                                       @error('blog_description_bn')
                                       <p class="text-danger">{{ $message }}</p>
                                       @enderror
                                    </div>
                                    <div class="form-group">
                                       <label for="blog_btn_en">Blog Button Name(En):</label>
                                    ...
                                    <div class="form-group">
                                       <label for="button_name_bn">Blog Button Name(Bn):</label>
                                       @error('button_name_bn')
                                       <span class="text-danger">{{ $message }}</span>
                                       @enderror
                                       <input type="text" name="button_name_bn" class="form-control" id="blog_btn_bn" placeholder="Write button name bangla">
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                       <label for="blog_image" class="col-form-label col-md-4" style="font-weight: bold;">Blog Image:(size:324,346)</label>
                  ...
                  <table id="example1" class="table table-bordered table-hover table-striped">
                     ...
                     <tbody>
                        ...
                        <tr>
                           ...
                           <td>{{ $service->blog_name_bn ?? 'NULL' }}</td>
                           <td>
                              @if($service->status == 1)
                                          ...
                                          <form action="{{ route('blog.update',$service->id) }}" method="post"  enctype="multipart/form-data">
                                             ...
                                             <div class="card-body">
                                                ...
                                                <div class="form-group">
                                                   ...
                                                   <span class="text-danger">{{ $message }}</span>
                                                   @enderror
                                                   <input type="text" name="blog_name_bn" class="form-control" id="blog_name_bn" value="{{ $service->blog_name_bn }}">
                                                </div>
                                                <div class="form-group">
                                                     <label for="menu_id">Menu Name:</label>
                                                     @error('menu_id')
                                                ...
                                                <div class="form-group">
                                                    <div class="form-group">
                                                        <label for="blog_description_bn" class="">Blog Description Bn</label>
                                                        <textarea name="blog_description_bn" class="description" cols="30" rows="7" class="form-control" >{{ $service->blog_description_bn }}</textarea>
                                                        @error('blog_description_bn')
                                                        <p class="text-danger">{{ $message }}</p>
                                                        @enderror
                                                     </div>
                                                ...
                                                <div class="form-group">
                                                   ...
                                                   <span class="text-danger">{{ $message }}</span>
                                                   @enderror
                                                   <input type="text" name="button_name_bn" class="form-control" id="blog_btn_bn" value="{{ $service->blog_btn_bn }}">
                                                </div>
                                                <div class="form-group">
                                                   <label for="blog_date">Blog Date:</label>
                                                   @error('blog_date')
