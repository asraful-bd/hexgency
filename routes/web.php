...
Route::prefix('skill')->group(function(){
	...
	Route::get('/skill-inactive/{id}', [SkillController::class, 'inactive'])->name('skill.in_active');
	Route::get('/skill-delete/{id}', [SkillController::class, 'destroy'])->name('skill.delete');
});
...
Route::prefix('offers')->group(function(){
	Route::get('/index', [OfferController::class, 'index'])->name('offer.index');
	...
	Route::get('/offer-inactive/{id}', [OfferController::class, 'inactive'])->name('offer.in_active');
	Route::get('/offer-delete/{id}', [OfferController::class, 'destroy'])->name('offer.delete');
