                                ...
                                <form action="{{ route('page.store') }}" method="post">
                                    ...
                                    <div class="card-body">
                                        <div class="form-group">
                                            <label for="name_en">Page En:</label>
                                            @error('name_en')
                                        ...
                                        <div class="form-group">
                                            <label for="name_bn">Page Bn:</label>
                                            @error('name_bn')
                                                <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                            <input type="text" name="name_bn" class="form-control" id="name_bn" placeholder="Write page name bangla">
                                        </div>
                                        <div class="form-group">
                  ...
                  <tbody>
                    @foreach($pages as $key => $page)
                        <tr>
                            ...
                            <td>{{ $page->name_bn ?? 'NULL' }}</td>
                            <td>{{ $page->title_en ?? 'NULL' }}</td>
                            <td>{{ $page->title_bn ?? 'NULL' }}</td>
                            <td>
                            ...
                            <td>
                                ...
                                <a data-toggle="modal" data-target="#descriptionBnModal{{ $page->id }}" href="#" class="btn btn-danger btn-sm">Details</a>

                                <!-- Scrollable modal -->
                                <div class="modal fade" id="descriptionBnModal{{ $page->id }}">
                                    <div class="modal-dialog modal-lg modal-dialog-scrollable">
                                      <div class="modal-content bg-primary">
                                        <div class="modal-header">
                                        	<h4 class="modal-title text-center" id="myModalLabel">{{ $page->title_bn }}</h4>
                                          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                            <span aria-hidden="true">&times;</span>
                                          </button>
                                        </div>
                                        <div class="modal-body bg-light">
                                          <p>{!! $page->description_bn !!}</p>
                                        </div>
                                        <div class="modal-footer justify-content-between bg-light">
                                          <button type="button" class="btn btn-outline-light" data-dismiss="modal">Close</button>
                                        </div>
                                                ...
                                                <div class="card-body">
			                                        ...
			                                        <div class="form-group">
			                                            ...
			                                            @error('name_bn')
			                                                <span class="text-danger">{{ $message }}</span>
			                                            @enderror
			                                            <input type="text" name="name_bn" class="form-control" id="name_bn" placeholder="Write page name bangla" value="{{ $page->name_bn }}">
			                                        </div>
			                                        <div class="form-group">
			                                            <label for="title_en">Title En:</label>
			                                            @error('title_en')
			                                        ...
			                                        <div class="form-group">
			                                            ...
			                                            @error('title_bn')
			                                                <span class="text-danger">{{ $message }}</span>
			                                            @enderror
			                                            <input type="text" name="title_bn" class="form-control" id="title_bn" placeholder="Write menu name bangla" value="{{ $page->title_bn }}">
			                                        </div>
			                                        <div class="form-group">
			                                            <label for="description_en">Description En:</label>
			                                            @error('description_en')
			                                                <span class="text-danger">{{ $message }}</span>
			                                            @enderror
			                                            <textarea name="description_en" class="form-control" id="description_en" rows="3" cols="5">{{ $page->description_en }}</textarea>
			                                        </div>
			                                        <div class="form-group">
			                                            <label for="description_bn">Description Bn:</label>
			                                            @error('description_bn')
			                                                <span class="text-danger">{{ $message }}</span>
			                                            @enderror
			                                            <textarea name="description_bn" class="form-control" id="description_bn" rows="3" cols="5">{{ $page->description_bn }}</textarea>
			                                        </div>
			                                        <div class="mb-4">
							                        	<label for="position" class="col-form-label" style="font-weight: bold;"> Position:</label>
							                            <div class="custom_select">
