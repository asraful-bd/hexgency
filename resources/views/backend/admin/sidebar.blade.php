...
<aside class="main-sidebar sidebar-dark-primary elevation-4 sidebar_common">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="info">
          <a href="#" class="d-block"><span>Hellow!</span></a></a>
        </div>
      </div>
      <!-- Sidebar Menu -->
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item">
              ...
              <a href="#" class="nav-link
                {{(request()->route()->getName()=='offer.index')?'active':''}}">
              ...
              <ul class="nav nav-treeview" style="background-color: #4975d6; border-radius:10px;">
                <li class="nav-item">
                  <a href="{{ route('offer.index') }}" class="nav-link {{(request()->route()->getName()=='offer.index')?'active':''}}">
                    <i class="far fa-circle nav-icon"></i>
                    <p>Manage Offer  <span class="badge badge-danger right">{{ DB::table('projects')->count() }}</span></p>
                  </a>
              </li>
              </ul>
            </li>
            ...
            <li class="nav-item">
                <a href="#" class="nav-link
                {{(request()->route()->getName()=='skill.index')?'active':''}}
              ...
              <ul class="nav nav-treeview" style="background-color: #4975d6; border-radius:10px;">
                <li class="nav-item">
                  <a href="{{ route('skill.index') }}" class="nav-link">
                    <i class="far fa-circle nav-icon"></i>
                    <p>Manage Skill <span class="badge badge-danger right">6</span></p>
                  </a>
              </li>
              </ul>
            </li>
            ...
            <li class="nav-item">
              <a href="#" class="nav-link
                {{(request()->route()->getName()=='pricing.index')?'active':''}}
              ...
              <ul class="nav nav-treeview" style="background-color: #4975d6; border-radius:10px;">
                <li class="nav-item">
                  <a href="{{ route('pricing.index') }}" class="nav-link">
                    <i class="far fa-circle nav-icon"></i>
                    <p>Manage Pricing <span class="badge badge-danger right">6</span></p>
                  </a>
              </li>
              </ul>
            </li>
