                            ...
                            <div class="modal-body">
                                <form action="{{ route('testimonial.store') }}" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                           <label for="testimonial_name_en">Testimonial Name(En):</label>
                                        ...
                                        <div class="form-group">
                                           <label for="testimonial_name_bn">Testimonial Name(Bn):</label>
                                           @error('testimonial_name_bn')
                                           <span class="text-danger">{{ $message }}</span>
                                           @enderror
                                           <input type="text" name="testimonial_name_bn" class="form-control" id="testimonial_name_bn" placeholder="Write testimonial name bangla">
                                        </div>
                                        <div class="form-group">
                                           <label for="testimonial_description_en" class="">Testimonial Description En</label>
                                        ...
                                        <div class="form-group">
                                           <label for="testimonial_description_bn" class="">Testimonial Description Bn</label>
                                           <textarea name="testimonial_description_bn" class="description" cols="30" rows="7" ></textarea>
                                           @error('testimonial_description_bn')
                                           <p class="text-danger">{{ $message }}</p>
                                           @enderror
                                        </div>
                  ...
                  <tbody>
                    @foreach($testimonials as $key => $testimonial)
                        <tr>
                            ...
                            <td>{{ $testimonial->name_bn ?? 'NULL' }}</td>
                            <td>{{ $testimonial->title_en ?? 'NULL' }}</td>
                            <td>{{ $testimonial->title_bn ?? 'NULL' }}</td>
                            <td>
                                            ...
                                            <form action="{{ route('testimonial.update',$testimonial->id) }}" method="post"  enctype="multipart/form-data">
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <div class="form-group">
                                                       ...
                                                       <span class="text-danger">{{ $message }}</span>
                                                       @enderror
                                                       <input type="text" name="name_bn" class="form-control" id="name_bn" value="{{ $testimonial->name_bn }}">
                                                    </div>
                                                    <div class="form-group">
                                                       <label for="title_en">Title En:</label>
                                                       @error('title_en')
                                                    ...
                                                    <div class="form-group">
                                                       ...
                                                       <span class="text-danger">{{ $message }}</span>
                                                       @enderror
                                                       <input type="text" name="title_bn" class="form-control" id="title_bn" value="{{ $testimonial->title_bn }}">
                                                    </div>
                                                    <div class="form-group">
                                                       <label for="testimonial_name_en">Testimonial Name(En):</label>
                                                       @error('testimonial_name_en')
                                                    ...
                                                    <div class="form-group">
                                                       ...
                                                       <span class="text-danger">{{ $message }}</span>
                                                       @enderror
                                                       <input type="text" name="testimonial_name_bn" class="form-control" id="testimonial_name_bn" value="{{ $testimonial->testimonial_name_bn }}">
                                                    </div>
                                                    <div class="form-group">
                                                       <label for="testimonial_description_en" class="">Testimonial Description En</label>
                                                    ...
                                                    <div class="form-group">
                                                        <div class="form-group">
                                                            <label for="testimonial_description_bn" class="">Testimonial Description Bn</label>
                                                            <textarea name="testimonial_description_bn" class="description" cols="30" rows="7" class="form-control" >{{ $testimonial->testimonial_description_bn }}</textarea>
                                                            @error('testimonial_description_bn')
                                                            <p class="text-danger">{{ $message }}</p>
                                                            @enderror
                                                         </div>
