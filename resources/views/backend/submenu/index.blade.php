                                ...
                                <form action="{{ route('submenu.store') }}" method="post">
                                    ...
                                    <div class="card-body">
                                      <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            <label for="name_en">SubMenu En:</label>
                                            @error('name_en')
                                        ...
                                        <div class="form-group">
                                            <label for="name_bn">SubMenu Bn:</label>
                                            @error('name_bn')
                                                <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                                  ...
                                                  <div class="form-group">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        @error('name_bn')
                                                            <span class="text-danger">{{ $message }}</span>
                                                        @enderror
                                                        <input type="text" name="name_bn" class="form-control" id="name_bn" placeholder="Write submenu name bangla" value="{{ $menu->menu->name_bn ?? 'Null' }}">
                                                    </div>
                                                    <div class="mb-4">
                                                        <div class="icheck-success d-inline">
