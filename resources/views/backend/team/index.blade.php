                            ...
                            <div class="modal-body">
                                <form action="{{ route('team.store') }}" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            <label for="description_en" class=""> Description En</label>
                                         ...
                                         <div class="form-group">
                                            <label for="description_bn" class="">Description Bn</label>
                                            <textarea name="description_bn" class="description" cols="30" rows="7" ></textarea>
                                         ...
                                         <div class="form-group">
                                            <label for="team_name_en">Team Name(En):</label>
                                            @error('team_name_en')
                                            <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                         ...
                                         <div class="form-group">
                                            <label for="team_name_bn">Team Name(Bn):</label>
                                            @error('team_name_bn')
                                            <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                            <input type="text" name="team_name_bn" class="form-control" id="team_name_bn" value="">
                                         </div>
                                         <div class="form-group">
                                         ...
                                         <div class="form-group">
                                            ...
                                            <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                            <input type="text" name="designation_bn" class="form-control" id="designation_bn" value="">
                                         </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
				                         	<img id="team_showImage" class="rounded avatar-lg" src="{{ (!empty($editData->profile_image))? url('upload/admin_images/'.$editData->profile_image):url('upload/no_image.jpg') }}" alt="Card image cap" width="100px" height="80px;">
				                        </div>
				                        <div class="form-group">
				                         	<label for="team_image" class="col-form-label col-md-4" style="font-weight: bold;">Team Photo (Size:261,279):</label>
				                            <input name="team_image" class="form-control" type="file" id="team_image">
				                            @error('team_image')
		                                  <p class="text-danger">{{$message}}</p>
		                                @enderror
				                        </div>
                  ...
                  <tbody>
                    @foreach($teams as $key => $team)
                        <tr>
                            ...
                            <td>{{ $team->name_en ?? 'NULL' }}</td>
                            <td>{{ $team->name_bn ?? 'NULL' }}</td>
                            <td>{{ $team->title_en ?? 'NULL' }}</td>
                            <td>{{ $team->title_bn ?? 'NULL' }}</td>
                            <td>
                                @if($team->status == 1)
                                            ...
                                            <div class="card-body">
                                                <div class="form-group">
                                                    ...
                                                    @error('name_en')
                                                        <span class="text-danger">{{ $message }}</span>
                                                    @enderror
                                                    <input type="text" name="name_en" class="form-control" id="name_en" value="{{ $team->name_en }}">
                                                </div>
                                                <div class="form-group">
                                                    <label for="name_bn">Name Bn:</label>
                                                    @error('name_bn')
                                                        <span class="text-danger">{{ $message }}</span>
                                                    @enderror
                                                    <input type="text" name="name_bn" class="form-control" id="name_bn" value="{{ $team->name_bn }}">
                                                </div>
                                                <div class="form-group">
                                                    <label for="title_en">Title En:</label>
                                                    @error('title_en')
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    @error('title_bn')
                                                        <span class="text-danger">{{ $message }}</span>
                                                    @enderror
                                                    <input type="text" name="title_bn" class="form-control" id="title_bn" value="{{ $team->title_bn }}" >                                              
                                                </div>
                                        ...
                                        <div class="form-group">
                                            <label for="submenu_id">SubMenu Name:</label>
                                                ...
                                                <div class="form-group">
                                                 ...
                                                 <div class="form-group">
                                                    <label for="description_bn" class="">Description Bn</label>
                                                    <textarea name="description_bn" class="description" cols="30" rows="7" >{{ $team->description_bn }}</textarea>
                                                    @error('description_bn')
                                                    <p class="text-danger">{{ $message }}</p>
                                                    @enderror
                                                 </div>
                                                 ...
                                                 <div class="form-group">
                                                    ...
                                                    <span class="text-danger">{{ $message }}</span>
                                                    @enderror
                                                    <input type="text" name="team_name_bn" class="form-control" id="team_name_bn" value="{{ $team->team_name_bn }}">
                                                 </div>
                                                 <div class="form-group">
                                                    <label for="designation_en">Designation(En):</label>
                                                    @error('designation_en')
                                                 ...
                                                 <div class="form-group">
                                                    ...
                                                    <span class="text-danger">{{ $message }}</span>
                                                    @enderror
                                                    <input type="text" name="designation_bn" class="form-control" id="designation_bn" value="designation_bn">
                                                 </div>
                                                <div class="form-group">
                                                    <label for="facebook">Facebook Link:</label>
                                                    @error('facebook')
                                                ...
                                                <div class="form-group">
                                                   ...
                                                   <div class="form-group">
        							                         	<img id="team_showImage" class="rounded avatar-lg" src="{{ asset($team->team_image) }}" alt="Project image" width="100px" height="80px;">
        							                        </div>
        							                        <div class="form-group">
        							                         	<label for="team_image" class="col-form-label col-md-4" style="font-weight: bold;">Team Photo (Size:261,279):</label>
        							                            <input name="team_image" class="form-control" type="file" id="team_image">
