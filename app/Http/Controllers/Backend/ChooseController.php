...
class ChooseController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if($request->name_bn == ''){
            $choose->name_bn = $request->name_en;
        }else{
            $choose->name_bn = $request->name_bn;
        }
        ...
        if($request->choose_name_bn == ''){
            $choose->choose_name_bn = $request->choose_name_en;
        }else{
            $choose->choose_name_bn = $request->choose_name_bn;
        }

        $choose->choose_description_en = $request->choose_description_en;
        if($request->choose_description_bn == ''){
            $choose->choose_description_bn = $request->choose_description_en;
        }else{
            $choose->choose_description_bn = $request->choose_description_bn;
        }
