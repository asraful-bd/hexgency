                            ...
                            <div class="modal-body">
                                <form action="{{ route('about.store') }}" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="card-body">
				                        ...
				                        <div class="form-group">
				                         	<label for="about_image" class="col-form-label col-md-4" style="font-weight: bold;">About Photo (Size:324,277):</label>
		                                ...
		                                <form action="{{ route('about.update',$about->id) }}" method="post" enctype="multipart/form-data">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div id="name_wrapper">
                                                       @php
                                                       $facilities = App\Models\AboutFacility::where('about_id', $about->id)->get();
                                                       @endphp
